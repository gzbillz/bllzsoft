...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src="<%=basePath%>/libs/loading.js" type="text/javascript" charset="UTF-8"></script>
    <script src="<%=basePath%>/libs/util.js" type="text/javascript" charset="UTF-8"></script>
    <script src="<%=basePath%>/libs/absPainter.js" type="text/javascript" charset="UTF-8"></script>
    <script src="<%=basePath%>/libs/ajax.js" type="text/javascript" charset="UTF-8"></script>
    <script src="<%=basePath%>/libs/crossLines.js" type="text/javascript" charset="UTF-8"></script>
    <script src="<%=basePath%>/libs/axis-x.js" type="text/javascript" charset="UTF-8"></script>
    <script src="<%=basePath%>/libs/tip.js" type="text/javascript" charset="UTF-8"></script>
    <script src="<%=basePath%>/libs/linepainter.js" type="text/javascript" charset="UTF-8"></script>
    <script src="<%=basePath%>/libs/volumePainter.js" type="text/javascript" charset="UTF-8"></script>
    <script src="<%=basePath%>/libs/axis-y.js" type="text/javascript" charset="UTF-8"></script>
    <script src="<%=basePath%>/libs/chartEventHelper.kl.js?a2" type="text/javascript" charset="UTF-8"></script>
    <script type="text/javascript" src="<%=basePath%>/libs/controller.js" charset="UTF-8"></script>
...
<body onload="drawKL()" style="padding:0;margin:2px">
    <canvas id="canvasKL" width="1002" height="390" style="z-index: 2; border: 1px solid #69c">
        <p>hey,您的浏览器不支持html5，换个浏览器吧，比如google chrome，firefox</p>
    </canvas>
    <div id="debug"></div>

    <script type="text/javascript" src="<%=basePath%>/t1/k-data.js"></script>
    <p><a href="<%=basePath%>/index.jsp">返回首页</a></p>
</body>
</html>