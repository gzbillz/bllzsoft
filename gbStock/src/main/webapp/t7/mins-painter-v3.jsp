...
<html>
	<head>
		...
		<title>minutes chart painter</title>
	    <style>
	   		pre {
	    ...
	    <script src="<%=basePath%>/libs/util.js?a" type="text/javascript" charset="UTF-8"></script>
	    <script src="<%=basePath%>/libs/absPainter.js" type="text/javascript" charset="UTF-8"></script>
	    <script src="<%=basePath%>/libs/ajax.js?a" type="text/javascript" charset="UTF-8"></script>
	    <script src="<%=basePath%>/libs/crossLines.js?a" type="text/javascript" charset="UTF-8"></script>
	    <script src="<%=basePath%>/libs/axis-x.js?a" type="text/javascript" charset="UTF-8"></script>
	    <script src="<%=basePath%>/libs/linepainter.js?a" type="text/javascript" charset="UTF-8"></script>
	    <script src="<%=basePath%>/libs/volumePainter.js?a" type="text/javascript" charset="UTF-8"></script>
	    <script src="<%=basePath%>/libs/axis-y.js?a" type="text/javascript" charset="UTF-8"></script>
	    <script src="<%=basePath%>/libs/chartEventHelper.js?a" type="text/javascript" charset="UTF-8"></script>
	</head>
<body>
    ...
    <div id="debug"></div>
    <script src="<%=basePath%>/t7/mins-data.js"></script><!---->
